...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void addQuestion(Question question) {
        ...
        cv.put(QuizContact.QuestionTable.COLUMN_QUESTION, question.getQuestion());
    ...
    public ArrayList<Question> getAllQuestions() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                question.setQuestion(c.getString(c.getColumnIndex(QuizContact.QuestionTable.COLUMN_QUESTION)));
